                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-md p-4 h-28">
                                            <CloudUploadIcon className="text-gray-400 mb-2" style={{ fontSize: 24 }} />
                                            <div>
                    ...
                    <div className="mr-4">
                        <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-gray-200">
                            <div className="bg-gray-800 h-full w-full flex items-center justify-center relative">
                                <div className="grid grid-cols-3 grid-rows-3 gap-0.5 absolute">
                                ...
                                <div className="text-white text-xs font-bold z-10">CS</div>
                            </div>
                        </div>
                    </div>
                    <div className="flex-1">
                        <div className="mb-2">
                            <div className="text-xs text-gray-500">Proudly Made by:</div>
                            <h2 className="text-lg font-bold">Home of Computer solutions</h2>
                            <div className="text-sm">We bring your ideas to reality.</div>
                        </div>
                        <div className="text-xs text-gray-500 max-w-md">
                            Service : Web and Mobile Application Development services,Data mining ,Data Analysis, Data Analytics And I.T Repairs ETC.
                        </div>
                    </div>
                    <div className="text-left text-xs space-y-1">
                            <div className="flex items-center gap-3">Manager:
                                <div className="text-gray-500 ">Mr. Tobaski Sibi</div>
                            </div>
                        <div className="flex items-center gap-3">Tele:
                            <div className="text-gray-500 ">711 9110</div>
                        </div>
                        <div className="flex items-center gap-3">Office Line:
                            <div className="text-gray-500 ">3334895</div>
                        </div>
                        <div className="flex items-center gap-3">Email:
                            <div className="text-gray-500 ">hocsolutions2024@gmail.com</div>
                        </div>
                        <div className="flex items-center gap-3">Address:
