...
const PayrollDetail = () => {
  ...
  useEffect(() => {
    if (currentAdmin && id) {
      ...
      console.log("Waiting for admin data or employee ID")
    }
    ...
    try {
      ...
      const hourlyRate =
        typeof employeeData.hourlyRate === "number"
          ...
          : Number.parseFloat(employeeData.hourlyRate) || 0
      ...
      const formattedEmployee = {
        ...
        overTime: totalOvertimeMinutes > 0 ? `${totalOvertimeHours} hours ${remainingOvertimeMinutes} mins` : "0 hours",
  ...
  return (
    <Box sx={{ p: 3, bgcolor: "#f5f5f5", minHeight: "100vh" }} data-export-content>
      ...
      <ExportModal
        ...
        data={employee}
        title={`Payroll Detail - ${employee.name}`}
      />
    </Box>
  )
}
